...
const commentsData = [
  {
    text: "Ξεκίνησα ψυχοθεραπεία για να επεξεργαστώ κάτι που με ταλαιπωρεί εδώ και χρόνια.\
          Η Σταυρούλα είναι ένας ζεστός άνθρωπος και νιώθω ότι με ακούει πραγματικά. Ήδη έχω αρχίσει να κατανοώ τη ρίζα της δυσκολίας μου.\
          Το να περιμένω τη συνεδρία κάθε Δευτέρα μου δίνει μια αίσθηση ανακούφισης!",
    author: "Ν."
  },
  {
    text: "Η Σταυρούλα με τις γνώσεις της μας βοηθά να κατανοήσουμε όσα μας απασχολούν σχετικά με τις δυσκολίες που αντιμετωπίζει ο γιος μας μετά την διάγνωση που πήρε απο τον παιδοψυχίατρο.\
