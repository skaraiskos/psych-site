...
const services = [
  {
    ...
    image: therapyImg,
    description: 'Ένα πλαίσιο συνεργασίας, ασφάλειας και εμπιστοσύνης, που επιτρέπει στο άτομο να επεξεργαστεί τη μοναδικότητα των εμπειριών του, να διερευνήσει πιθανές λύσεις στο πρόβλημά του και να εκπαιδευτεί στην εφαρμογή των νέων πρακτικών του.',
    callToAction : {
