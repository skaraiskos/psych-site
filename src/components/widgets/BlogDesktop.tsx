      ...
      <div className="grid grid-cols-[2.2fr_1fr] gap-10">
        ...
        <div className="flex flex-col gap-6">
          {posts.map(({ slug, title, image, publishDate, excerpt }) => (
            <div
              key={slug}
              className="group flex flex-col md:flex-row overflow-hidden md:mb-8"
            >
              ...
              <div className="p-4 md:mx-4 flex flex-col justify-between gap-3 w-full">
                ...
                <Link
                  href={`/blog/${slug}`}
                  className="hidden md:inline-block text-sm font-medium text-gray-500 hover:text-gray-800 hover:translate-x-1 transition-transform"
                >
                  Read more..
                </Link>
