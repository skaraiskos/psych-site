  ...
  return (
    <section className="relative w-full bg-theme2 overflow-hidden">
      ...
      <div className="md:hidden flex flex-col bg-theme2">
        ...
        {/* BOTTOM — CONTENT */}
        <div className="flex-1 px-6 py-8 text-black flex flex-col justify-center w-[90%] mx-auto">
         ...
         <div className="space-y-4 text-base leading-relaxed text-text/90 pointer-events-none">
            ...
            <p>
              Παρέχω ατομική ψυχοθεραπεία σε ενήλικες και εφήβους, συμβουλευτική υποστήριξη γονέων, και είμαι πιστοποιημένη εκπαιδεύτρια του "Εργαστηρίου Αποτελεσματικού Γονέα".
            </p>
          </div>
      ...
      <div className="hidden md:block max-w-7xl mx-auto px-6 py-8 lg:py-10">
        ...
        <div className="grid grid-cols-[1fr_1.25fr] gap-14 items-center">
          ...
          <div className="relative">
            ...
            {/* Back image */}
            {image2 && (
              <div className="relative w-[82%] h-[580px] ml-auto rounded-xl overflow-hidden">
                <Image
                  src={image2.src}
                  alt={image2.alt}
                  fill
