      ...
      <div className="md:hidden flex flex-col min-h-screen bg-theme2">
        ...
        <div className="flex-1 px-6 py-8 text-black flex flex-col justify-center">
         ...
         <div className="space-y-4 text-base leading-relaxed text-text/90 pointer-events-none">
            ...
            <p>
              Το παρελθόν αποτελεί αναπόσπαστο κομμάτι της εμπειρίας μας. Δεν χρειάζεται να το απορρίψουμε, αλλά να το κατανοήσουμε και να το επεξεργαστούμε, ώστε να μετατραπεί σε πηγή γνώσης και εξέλιξης, αντί να λειτουργεί ως εμπόδιο στην προσωπική μας πορεία.
            </p>
          </div>
