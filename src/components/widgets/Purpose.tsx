    ...
    >
      ...
      >
        ...
        >
          ...
          <p className="pointer-events-none mx-auto mt-4 max-w-5xl text-base text-white text-center">
            Μέσα από τη θεραπευτική διαδικασία, δίνεται η δυνατότητα το άτομο να έρθει σε επαφή με τις ανάγκες και τα συναισθήματά του, να κατανοήσει βαθύτερα τον εαυτό του και να αναπτύξει πιο λειτουργικούς τρόπους σκέψης και διαχείρισης στις σχέσεις και στην καθημερινότητά του.
          </p>
          <p className="pointer-events-none mx-auto mt-4 max-w-5xl text-base text-white text-center">
            Παράλληλα, η επεξεργασία των προσωπικών εμπειριών και του παρελθόντος μπορεί, ανάλογα με τις ανάγκες και τον ρυθμό του κάθε ανθρώπου, να αποτελέσει πηγή γνώσης και κατανόησης του τρόπου με τον οποίο βιώνει το παρόν.
          </p>
          <p className="pointer-events-none mx-auto mt-4 max-w-5xl text-base text-white text-center">
