...
const pillars = [
  {
    title: "Αποδοχή",
    description: "Κάθε άνθρωπος αντιμετωπίζεται με σεβασμό και αποδοχή ως μοναδική προσωπικότητα.",
    icon: IconEye,
  },
  {
    title: "Εμπιστοσύνη",
    description: "Αποτελεί θεμέλιο της θεραπευτικής σχέσης η οποία επιτρέπει τη δημιουργία ενός ασφαλούς πλαισίου συνεργασίας και εξερεύνησης του εαυτού αλλά και της κατανόησης σκέψεων, συναισθημάτων και μοτίβων συμπεριφοράς.",
    icon: IconShieldLock,
  },
  {
    title: "Ενσυναίσθηση",
    description: "Η προσέγγιση βασίζεται στην κατανόηση της εμπειρίας του ατόμου μέσα από τη δική του οπτική, με σεβασμό και χωρίς κριτική διάθεση.",
    icon: IconHeart,
  },
  {
    title: "Αυθεντικότητα",
    description: "Η θεραπευτική στάση στηρίζεται στην αυθεντικότητα και την ειλικρίνεια, καθώς η ουσιαστική υποστήριξη βασίζεται σε μια καθαρή και αληθινή επικοινωνία.",
...
const data = {
    description1: 'Είμαι πτυχιούχος **Ψυχολόγος** με άδεια ασκήσεως επαγγέλματος (Αρ. Αδείας: 212058, Νομαρχία Αθηνών) και κάτοχος μεταπτυχιακού τίτλου στις **Επιστήμες της Αγωγής** και την **Ειδική Εκπαίδευση**. Βρίσκομαι στο τελικό στάδιο ολοκλήρωσης της εκπαίδευσής μου στη **Γνωσιακή Συμπεριφορική Ψυχοθεραπεία**.split\
                    Έχω ολοκληρώσει τρεις ετήσιες μετεκπαιδευτικές **εξειδικεύσεις** (Pearson, BTEC Level 5) που αφορούν τη διαχείριση και παρέμβαση σε παιδιά με **συναισθηματικές και συμπεριφορικές δυσκολίες**, τη **Διαταραχή Αυτιστικού Φάσματος**, καθώς και την αξιολόγηση και υποστήριξη παιδιών με **ειδικές εκπαιδευτικές ανάγκες και δυσλεξία**. Παράλληλα, έχω εκπαιδευτεί ως **συντονίστρια ομάδων εφήβων** και έχω παρακολουθήσει πλήθος σεμιναρίων με αντικείμενα όπως η παιγνιοθεραπεία, το παιδικό ιχνογράφημα, η μέθοδος Montessori, η διαχείριση της απώλειας στην παιδική ηλικία, οι θεραπευτικές ιστορίες, το παιχνίδι στο φάσμα του αυτισμού, η ενίσχυση της αυτοεκτίμησης, η γνωστική ανάπτυξη απο την βρεφική ηλικία ως την εφηβεία κ.α.split\
                    Είμαι πιστοποιημένη εκπαιδεύτρια του **«Εργαστηρίου Αποτελεσματικού Γονέα»** από την Gordon International Training και συντονίζω ομάδες γονέων, μέσα από τις οποίες ενισχύεται ο γονεϊκός ρόλος και καλλιεργούνται πιο λειτουργικοί τρόποι ανταπόκρισης στις καθημερινές προκλήσεις, με περισσότερη ηρεμία, σαφήνεια και αυθεντικότητα.', 
    description2: 'Μέσα από την επαγγελματική μου εμπειρία, την εκπαίδευση και τη συνεχή προσωπική και θεραπευτική μου εξέλιξη, προσεγγίζω τη γονεϊκότητα ως μια σχέση που χρειάζεται σύνδεση, κατανόηση και συναισθηματική ασφάλεια. Πιστεύω στη σημασία της αυθεντικής επαφής ανάμεσα στον γονέα και το παιδί και στη φροντίδα των αναγκών και των συναισθημάτων και των δύο. Στόχος μου είναι να στηρίζω τους γονείς ώστε να αισθάνονται μεγαλύτερη επάρκεια, ηρεμία και εγγύτητα μέσα στη σχέση με το παιδί τους.split\
                    Από το 2012 συνεργάζομαι με κέντρα ειδικών θεραπειών, παρέχοντας υποστήριξη σε παιδιά και εφήβους. Παράλληλα, έχω συντονίσει ομάδες κοινωνικών δεξιοτήτων για παιδιά στο φάσμα του αυτισμού, καθώς και ομάδες εφήβων με στόχο τη συναισθηματική ενδυνάμωση και την ανάπτυξη της αυτογνωσίας. Αναπόσπαστο μέρος της επαγγελματικής μου πορείας αποτελεί η συμβουλευτική γονέων.split\
                    ...
                    Έτσι διεύρυνα την επαγγελματική μου κατεύθυνση προς την ψυχοθεραπευτική υποστήριξη ενηλίκων, μέσα από τη Γνωσιακή Συμπεριφορική Ψυχοθεραπεία, στην οποία ολοκληρώνω τη συστηματικά εποπτευόμενη κλινική μου κατάρτιση.split\
  ...
  return (
    <section className="w-full bg-theme2 text-text md:text-base text-justify">
      ...
      <div className="max-w-7xl mx-auto px-6 pt-24 pb-0 grid md:grid-cols-[420px_1fr] gap-16 items-start">
        ...
        <div className="flex flex-col gap-10 md:w-full w-[90%] mx-auto">
      ...
      <div className="md:w-full w-[90%] mx-auto px-6 pt-8 pb-12 bg-theme2">
      ...
      <div className="relative w-full py-28 md:my-10 text-center">
        ...
        >
          ...
          {/*<p className="text-theme2/90 leading-relaxed">
            Η θεραπευτική διαδικασία βασίζεται στην κατανόηση της εμπειρίας και των αναγκών του ατόμου, μέσα σε ένα ασφαλές και υποστηρικτικό πλαίσιο. Στόχος είναι η ουσιαστική επεξεργασία των δυσκολιών, η ενίσχυση της ψυχικής ανθεκτικότητας και η βελτίωση της ποιότητας ζωής.
          </p>*/}
        </motion.div>
      </div>
        ...
        {pillars.map(({ title, description, icon: Icon }, index) => {
          ...
          return (
            ...
            >
              ...
              <div className="absolute left-0 top-8 bottom-8 w-[3px] bg-theme6 rounded-full opacity-60" />
              ...
              <div className="flex-1 mt-4">
                <p className="text-sm text-theme6 text-left leading-relaxed">
                  {description}
                </p>
              </div>
            </motion.div>
