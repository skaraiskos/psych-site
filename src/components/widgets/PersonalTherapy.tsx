...
const data = {
    ...
    description2: 'Στη **θεραπευτική διαδικασία** εστιάζουμε στην κατανόηση των παραγόντων που πυροδοτούν τις δυσκολίες, καθώς και στα μοτίβα που τις συντηρούν, όπως οι αρνητικές σκέψεις, οι συμπεριφορές αποφυγής και οι σωματικές αντιδράσεις. Μέσα από τη {{practice}}, οι θεραπευόμενοι εξοικειώνονται με δεξιότητες και τεχνικές, με στόχο να μπορούν να διαχειρίζονται την καθημερινότητά τους με μεγαλύτερη ευελιξία και αποτελεσματικότητα.split\
                    Παράλληλα, η επεξεργασία των προσωπικών εμπειριών και του παρελθόντος μπορεί, ανάλογα με τις ανάγκες και τον ρυθμό του κάθε ανθρώπου, να αποτελέσει πηγή γνώσης και βαθύτερης κατανόησης του εαυτού και του τρόπου με τον οποίο βιώνει το παρόν.split\
